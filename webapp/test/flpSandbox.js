					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OJT  homework 1 ",
									"targetURL": "#zhw1tultt3-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"zhw1tultt3-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zhw1tultt3",
									"url": sap.ui.require.toUrl("zhw1tultt3")
								}
							}
						}
					}
